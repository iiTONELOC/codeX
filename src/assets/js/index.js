document.addEventListener('DOMContentLoaded', () => {
    ...
    *       url: string - The crafted URL to search GitHub with.
    ...
    function historyItem(_history) {
        ...
        return (
            `<li tabindex=0 id=${_history.time} ${pinkFocus}>
            ...
            <section>
                <a href="${_history.url}" target="_blank" rel="noopener noreferrer" ${pinkFocus}>${pEl()}</a>
            </section>

            ${svgIcon(`<path ${pinkFocus} tabindex=0 data-id=${_history.time} fill-rule="evenodd" d="M9 2a1 1 0 00-.894.553L7.382 4H4a1 1 0 000 2v10a2
    ...
    function renderHistoryItem(_item) {
        document.querySelector('#history-list').innerHTML += String(historyItem(_item));
    }
